"""
    Base Django settings for the machina-demo demo project
    ======================================================
...
INSTALLED_APPS = [
    ...
    'demo.forum_apps.forum_conversation',
    'demo.forum_apps.forum_member',
])
...
STATICFILES_DIRS = (
    ...
    str(PROJECT_PATH / 'demo' / 'static' / 'build'),
    str(PROJECT_PATH / 'demo' / 'static'),
)
